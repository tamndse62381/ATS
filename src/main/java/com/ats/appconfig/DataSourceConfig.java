...
@EnableJpaRepositories(basePackages ={
        "com.ats.repository" }
,entityManagerFactoryRef = "ATSEntityManagerFactory",transactionManagerRef = "ATSTransactionManager")
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean ATSEntityManagerFactory() throws SQLException {
        ...
        factoryBean.setDataSource(rmsDataSource());
